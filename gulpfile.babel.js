...
function watch() {
  ...
  gulp.watch('src/templates/**/*.html').on('all', gulp.series(browser.reload));
  gulp.watch('src/template/{includes, components, snippets}/**/*.html').on('all', gulp.series(browser.reload));
